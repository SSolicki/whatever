<script>
	...
	import { updateVectorDBConfig, testVectorDBConfig } from '$lib/apis/retrieval';

	import Documents from './Settings/Documents.svelte';
	import WebSearch from './Settings/WebSearch.svelte';
	import DatabaseConfig from '$lib/components/admin/Knowledge/DatabaseConfig.svelte';
...
<div class="flex flex-col lg:flex-row w-full h-full pb-2 lg:space-x-4">
	...
	>
		...
		<div class=" self-center">{$i18n.t('Vector DB')}</div>
	</button>
